...
<head>
    ...
    <title>Detail - {{ $jenisPohon->nama_jenis_pohon }}</title>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-12 pb-5">
                            <div class="mb-2 text-center bg-white theme-shadow rounded-4 py-4">
                                <h1 class="text-success display-5">Tre/{{$speciesCode}}</h1>
                    ...
                    <div class="col-md-4" data-aos="fade-down" data-aos-delay="150">
                        <div class="portfolio-item image-zoom">
                            <div class="image-zoom-wrapper">
                                <img src="{{ asset('images/' . $pohon->gambar_pohon) }}" alt="Gambar Pohon">
                            </div>
                            <a href="{{ asset('images/' . $pohon->gambar_pohon) }}" data-fancybox="gallery" class="iconbox">
