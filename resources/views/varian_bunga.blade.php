            ...
            <div class="row">
                <div class="col-12 text-center" data-aos="fade-down" data-aos-delay="100">
                    <div class="section-title">
                        <h1 class="display-4 fw-semibold">Varian Jenis Bunga</h1>
                        <div class="line" style="margin: 16px auto 24px auto;"></div>
                    </div>
                </div>
            </div>
            <div class="row g-4 text-center">
            @foreach ($varianbunga as $jenis)
            <div class="col-md-4" data-aos="fade-down" data-aos-delay="150">
                <a href="{{ route('detail-bunga.show', ['id' => $jenis->id]) }}">
                    <div class="feature-card" style="background-image: url({{ asset('images/' . $jenis->gambar_bunga) }});">
                        <h3 class="feature-title mb-0 text-white">{{ $jenis->nama_jenis_bunga }}</h3>
                    </div>
                </a>
            </div>
            @endforeach
