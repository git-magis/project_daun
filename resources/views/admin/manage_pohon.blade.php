...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">🌲Tabel Pohon</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body">
                                Klik <strong>Tambah Pohon</strong> untuk menambahkan data, beberapa hal yang perlu diperhatikan:
                                <br><br>1. Penamaan pohon menyesuaikan dengan jenis pohon.
                                ...
                                <br>4. Isi kolom <strong>Gambar</strong> dengan foto pohon masing-masing. 
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('pohon.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_id" id="jenisPohon" class="form-control" required>
                                <option value="" disabled selected>Choose...</option>
                                @isset($jenis_pohon)
                                    @foreach($jenis_pohon as $jenis)
                                        <option value="{{ $jenis->id }}">{{ $jenis->nama_jenis_pohon }}</option>
                                    @endforeach
                                @endisset
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="lokasi_id" id="lokasiPohon" class="form-control" required>
                                <option value="" disabled selected>Choose...</option>
                                @isset($taman_lokasi)
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="gambar_pohon" class="form-control-file" id="gambarPohon">
                        </div>
                        <div class="modal-footer">
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST" action="{{ route('pohon.update', ':id') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="editJenis" name="jenis_id" class="form-control" required>
                                @isset($jenis_pohon)
                                    @foreach($jenis_pohon as $jenis)
                                        <option value="{{ $jenis->id }}">{{ $jenis->nama_jenis_pohon }}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select id="editLokasi" name="lokasi_id" class="form-control" required>
                                @isset($taman_lokasi)
                                    @foreach($taman_lokasi as $lokasi)
                                        <option value="{{ $lokasi->id }}">{{ $lokasi->nama }}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="editTanam" name="tanggal_tanam" value="{{ old('tanggal_tanam', $pohon->tanggal_tanam ?? '') }}">
                        </div>
                        <div class="form-group">
    ...
    <script>
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            $('#currentImagePreview').html('<img src="' + imagePath + '" width="100" alt="euweuhan">');
        });
        ...
        jumlahInputField.addEventListener("input", function () {
            ...
            document.getElementById("gambarPohon").disabled = isBulk;
        });
