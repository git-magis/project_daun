            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background-image: url({{asset('images/siskalogo-2.png')}}); background-position: center; background-size: 25vh; background-repeat: no-repeat;"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
